...
let menu, prod, section, total = 0, value = 0;
...
do{
    section = parseInt(prompt('Seleccione un categoría: \n1.Tarjeta gráfica \n2.Procesador \n3.Memoria RAM \n4.Gabinete \n0.Cerrar su compra'));

    while(section !== 1 && section !== 2 && section !== 3 && section !== 4 && section !== 0){
        datoInvalido();

        section= parseInt(prompt('Por favor, vuelva a seleccionar una: \n1.Tarjeta gráfica \n2.Procesador \n3.Memoria RAM \n4.Gabinete \n0.Cerrar su compra'));
    }
